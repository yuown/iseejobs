...
iseejobsApp.controller('AlertsLendController', [ '$scope', '$modal', 'AjaxService', function($scope, $modal, AjaxService) {
    'use strict';
...
iseejobsApp.controller('AlertsSellController', [ '$scope', '$modal', 'AjaxService', function($scope, $modal, AjaxService) {
    'use strict';
