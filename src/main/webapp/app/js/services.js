iseejobsApp.factory('AuthenticationService', ['$http', '$cookieStore', '$rootScope', 'AjaxService', function($http, $cookieStore, $rootScope, AjaxService) {
	'use strict';
...
iseejobsApp.factory('AjaxService', [ '$rootScope', '$http', function($rootScope, $http) {
...
iseejobsApp.directive('access', ['AuthenticationService', function(AuthenticationService) {
	return {
        restrict: 'A',
