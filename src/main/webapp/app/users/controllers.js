iseejobsApp.controller('UsersController', [ '$scope', 'AjaxService', '$modal', 'AlertsService', function($scope, AjaxService, $modal, AlertsService) {
    'use strict';
...
iseejobsApp.controller('AddUserController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
...
iseejobsApp.controller('GroupsController', [ '$scope', 'AjaxService', '$modal', 'AlertsService', function($scope, AjaxService, $modal, AlertsService) {
	'use strict';
...
iseejobsApp.controller('AddGroupController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
...
iseejobsApp.controller('GroupAuthoritiesController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
...
iseejobsApp.controller('GroupUsersController', [ '$scope', 'AjaxService', '$modal', function($scope, AjaxService, $modal) {
...
iseejobsApp.controller('AddUserToGroupController', [ '$scope', 'AjaxService', '$modal', function($scope, AjaxService, $modal) {
